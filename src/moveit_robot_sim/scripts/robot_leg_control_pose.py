...
def main():
    ...
    leg_1 = MyRobot("leg1_group")
    leg_2 = MyRobot("leg2_group")
    leg_3 = MyRobot("leg3_group")
    leg_4 = MyRobot("leg4_group")
    leg_13 = MyRobot("legs13_group")
    leg_24= MyRobot("legs24_group")
    leg_134= MyRobot("leg_1_3_4_group")
    leg_234= MyRobot("leg_2_3_4_group")
    ...
    leg_24.set_pose("zero_position_s2")
    #Wait for 2 seconds
    rospy.sleep(2)
